<template>
  <div class="login-bg">
    <el-card class="login-card" shadow="always">
      <div class="login-title"><el-icon size="28"><Van /></el-icon><span>BOM 零部件管理系统</span></div>
      ...
      <div class="login-hint">演示账号 admin/admin123 · eng/eng123 · plan/plan123 · viewer/viewer123</div>
    </el-card>
  </div>
</template>
